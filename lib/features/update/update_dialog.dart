...
class UpdateDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rawSha256 = updateInfo['sha256'] as String?;
    final normalizedSha256 = rawSha256?.trim().toLowerCase();
    final hasValidSha256 =
        normalizedSha256 != null &&
        RegExp(r'^[a-f0-9]{64}$').hasMatch(normalizedSha256);
    final shortHash = hasValidSha256 ? normalizedSha256.substring(0, 8) : null;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Subtitle
                        Text(
                          'A new version is available with stability and security improvements.',
                          style: TextStyle(
                            fontSize: 14.sp,
                                ...
                                ...List.generate(
                                  ...
                                  (index) => Padding(
                                    padding: EdgeInsets.only(
                                      bottom: index < changelog.length - 1
                                          ? 14.h
                                          : 0,
                                    ),
                                    child: Row(
                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    ...
                                    // Keep this mandatory dialog open; installer or errors are shown on top.
